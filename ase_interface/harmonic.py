...
class harmonic_potential(Calculator):
    ...
    default_parameters = {
                          ...
                          'bounds_geom':[]
#                          'reference_confs':[]      # no bias potential for regular MD
                         }
    ...
    valid_args = ['mode', 'k', 'R0', 'shift', \
                  ...
                  'restrained_atoms', 'reference_geom', 'bounds_geom',\
                  'reference_confs']
...
#                    print( self.restrain_level*norm/2., -self.restrain_level * dpos)
...
#                if iAtom == 2 and jAtom == 4: print(distances[iAtom,jAtom])
